...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: Category, arg4: string): Promise<void> {
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "accessories" in value ? Category.accessories : "tops" in value ? Category.tops : "bottoms" in value ? Category.bottoms : value;
}
